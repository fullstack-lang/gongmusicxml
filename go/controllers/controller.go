...
import (
	...
	gongmusicxml_orm "github.com/fullstack-lang/gongmusicxml/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*gongmusicxml_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*gongmusicxml_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *gongmusicxml_orm.BackRepoStruct, stackPath string) {
