...
import (
	...
	"github.com/fullstack-lang/gongmusicxml/go/fullstack"
	"github.com/fullstack-lang/gongmusicxml/go/models"
	"github.com/fullstack-lang/gongmusicxml/go/orm"
	"github.com/fullstack-lang/gongmusicxml/go/probe"

	gongmusicxml_go "github.com/fullstack-lang/gongmusicxml/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongmusicxml/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongmusicxml_go.GoModelsDir, gongmusicxml_go.GoDiagramsDir,
