...
import (
	...
	"github.com/fullstack-lang/gongmusicxml"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongmusicxml.NgDistNg, "ng-github.com-fullstack-lang-gongmusicxml/dist/ng-github.com-fullstack-lang-gongmusicxml/browser")))
